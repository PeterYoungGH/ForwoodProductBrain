...
What feedback does EDP have regarding items they believe are still needed to meet contractual requirements, and what operational issues are affecting their use of Forwood's Safety+ and QuickSight tools?

## Objectives

- Document EDP's perspective on outstanding contractual requirements
- Capture operational and stability issues affecting daily use
- Identify usability and workflow improvement needs
- Understand the gap between EDP's expectations and Forwood's current product capabilities

## Methodology

### Research Method
Customer feedback communication from EDP

### Participants/Data Sources
- EDP (key customer account)
- Feedback provided in December 2025
- Note: Forwood does not believe these items are contractual requirements, but EDP does
...
EDP believes the following items are still needed to meet contractual requirements (should have been closed by end of October):
...
### Finding 3: Corrective and Evolutionary Service Requests
...
- **Contract alignment gap**: There is a disconnect between what EDP believes is contractual and what Forwood believes is contractual
...
- **Localization priority**: Spanish language support needed for questions/questionnaires
...
- [Source: EDP Feedback Inbox Item](../../../00-inbox/raw/2025-12-01-edp-feedback-[PROCESSING].md)
- [EDP Customer Feedback Insights](../../../03-discovery/insights/2025-12-01-edp-feedback-insights.md)
- [Related: EDP Pain Points and Requests Research](./edp-pain-points-and-requests-2025-12.md)
