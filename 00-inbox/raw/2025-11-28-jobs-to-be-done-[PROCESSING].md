# Jobs to Be Done (JTBD): Overview & Quickstart - Processing
...
Use JTBD alongside:
- **Four Risks Framework** — to validate that solutions address real jobs
- **Delight Pillars** — to design experiences that reduce struggle in the job
- **20 First Principles** — to ensure execution supports the job outcomes
