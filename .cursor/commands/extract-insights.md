...
Command to extract key insights from research documents, customer feedback, market data, or other source materials.
...
- `process-inbox-todo` - Uses insight extraction when processing research items
- `synthesize-research` - May use insight extraction as part of synthesis
